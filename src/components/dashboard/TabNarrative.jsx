            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  <div className="font-mono text-xl text-slate-800 dark:text-slate-200">#{homePerf.actual_league_position || '?'} <span className="text-[10px] text-slate-500 font-sans tracking-widest uppercase">Général</span></div>
                  <div className="font-mono text-sm text-slate-500 dark:text-slate-400">#{home.rank_home || '?'} <span className="text-[10px] font-sans tracking-widest uppercase">Dom.</span></div>
                </div>
              </div>
            ...
            <div className="space-y-4 text-right">
              <div>
                ...
                <div className="flex items-baseline justify-end gap-2">
                  <div className="font-mono text-sm text-slate-500 dark:text-slate-400">#{away.rank_away || '?'} <span className="text-[10px] font-sans tracking-widest uppercase">Ext.</span></div>
                  <div className="font-mono text-xl text-slate-800 dark:text-slate-200">#{awayPerf.actual_league_position || '?'} <span className="text-[10px] text-slate-500 font-sans tracking-widest uppercase">Général</span></div>
                </div>
              </div>
