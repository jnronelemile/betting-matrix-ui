        ...
        <Card title="Diagnostics Moteur (V8.2)" titleIcon={<Calculator size={16} />}>
          <div className="flex flex-col gap-5 mt-1">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-slate-950 p-3 sm:p-4 rounded-xl border border-slate-800 text-center shadow-inner flex flex-col justify-center relative overflow-hidden">
